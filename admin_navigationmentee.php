...
//if(!$connection){ echo "Sorry no database connection";}
...
<div class="wrapper" style="margin-top:-3.7%;">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Mentee</b>&nbsp; Profile</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?php echo $username;  ?> - Admin (Mentee)
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="Menteeform.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
	   ...
	   <li>
          <a href="#">
            <i class="fa fa-user-plus"></i><span>    <h5><?php echo  $username;  ?></h5>'s Profile</span>
