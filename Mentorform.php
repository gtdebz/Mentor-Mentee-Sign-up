    ...
    <div class="container">
      <div class="flex-container">  
        ...
        <li><a href="#"> Call: <b>+234-9084091211</b></a></li>
         <li><a href="#"> Email: <b>trainer@gmail.com</b></a></li>
...
<form action="Mentorserver.php" method="post" >
<div id="loginform" >
<center><h1><b>LOGIN AS MENTOR</b></h1></center>
...
<button class="btn" type="submit" name="login-submit" >LOGIN</button>
 ...
 <form action="Mentorserver.php" method="post" >
<div id="signupform">
<center><h1><b>SIGN UP AS MENTOR</b></h1></center>
